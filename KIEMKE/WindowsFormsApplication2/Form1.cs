...
namespace WindowsFormsApplication2
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            xlWorkBook.SaveAs("X:\\Public\\IT-Information Technology Dept\\BAOCAOKIEMKEIT\\" + ten + ".xlsx", Excel.XlFileFormat.xlOpenXMLWorkbook, misValue, misValue, false, false, Excel.XlSaveAsAccessMode.xlNoChange, Excel.XlSaveConflictResolution.xlUserResolution, true, misValue, misValue, misValue);
            xlWorkBook.Close(true, misValue, misValue);
            xlApp.Quit();
            MessageBox.Show("Excel file created , you can find the file X:\\Public\\IT-Information Technology Dept\\BAOCAOKIEMKEIT\\test.xlsx");
        }
